...
public sealed class InactiveMembershipAccessTests
{
    [Fact]
    public async Task Login_fails_when_only_membership_is_inactive()
    {
        ...
        membership.Status = AIUsageGuard.Application.Models.MembershipStatus.Inactive;
